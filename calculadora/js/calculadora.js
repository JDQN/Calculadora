// Variables
//En esta parta colocamos la constante o 
//const y llamamos el evento getElementById ()
...
// Events Listeners
//En esta parta se realiza casi el mismo código que el de las variables 
//solo que es este caso colocamos el nombre de la 
//funcion ejemplo -> clear, sumar etc y llamamos al evento -> 
//eventListeners(); y function eventListeners(){clear.addeventListener('click',limpiar)}
...
function eventListeners(){
    ...
    pun.addEventListener('pnto', punto)
    igual.addEventListener('click', equal)
}

//Función
//En esta parte llamo la funcion de cada una de las 
//operaciones  ejemplo -> function multipicacion() {
